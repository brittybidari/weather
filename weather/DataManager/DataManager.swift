...
protocol WeatherFetcher {
  ...
  func weatherSummary(for latlng: CLLocationCoordinate2D) -> AnyPublisher<WeatherSummary, WeatherError>
...
extension DataManager: WeatherFetcher {
    ...
    //MARK: - Fetch Weather Summary By LatLng
    func weatherSummary(for coordinates: CLLocationCoordinate2D) -> AnyPublisher<WeatherSummary, WeatherError> {
        getCoordinates(forCoordinates: coordinates)
    ...
    //MARK: - Fetch Weather Summary By City
  func weatherSummary(forCity city: String) -> AnyPublisher<WeatherSummary, WeatherError> {
...
private extension DataManager {
  ...
  func makeWeatherSummaryComponents(withCoordinates coordinates: CLLocationCoordinate2D) -> URLComponents {
    ...
    func getCoordinates(forCoordinates coordinates: CLLocationCoordinate2D) -> AnyPublisher<CLLocationCoordinate2D, WeatherError> {
 ...
 //MARK: - Get Latitude and Longitude by Address
